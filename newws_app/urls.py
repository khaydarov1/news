...
from .views import news_list, news_detail, homePageView, contactPageView, page404View, aboutPageView, \
    LocalNewsViews, SportNewsViews, TechnoNewsViews, XorijNewsViews, NewsDeleteView, NewsCreatrView, NewsUpdateView


urlpatterns = [
    path('', homePageView, name="home_page"),
    path('news/', news_list, name="all_news_list"),
    path('create/', NewsCreatrView.as_view(), name='news_create'),
